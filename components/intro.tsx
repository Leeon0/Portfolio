  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="100"
              priority={true}
              className="h-35 w- rounded-full object-cover border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      >
        ...
        <span className="font-bold">The University of Madeira</span>. Based in Portugal. Simplifying complexity through thoughtful code.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/leo-roquett-5512aa267/"
          target="_blank"
        >
